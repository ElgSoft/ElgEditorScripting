...
// Cross Module References
	...
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_CanEverTick();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_CanEverTickBranch();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_CompileBlueprint();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_DeleteNodesByName();
	...
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_GetBlueprintNodeStat();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_GetBlueprintsByPath();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_GetBlueprintsFromObjects();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_GetBlueprintsNodeStat();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_GetLocalVariableNames();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_GetNativeClass();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_GetNodeStatsByPath();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_GetNodeUsage();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_GetParentClass();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_GetUnusedLocalVariableNames();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_GetVariableNames();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_HasCompilerError();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_HasCompilerErrorBranch();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_HasNode();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_HasNodeBranch();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_IsChildOfClass();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_IsChildOfClassBranch();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_IsConstructionScriptConnected();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_IsConstructionScriptConnectedBranch();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_IsNodePinConnected();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_IsNodePinConnectedBranch();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_IsRunConstructionScriptOnDrag();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_IsRunConstructionScriptOnDragBranch();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_IsStartingWithTick();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_IsStartingWithTickBranch();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_RemoveLocalVariable();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_RemoveUnusedLocalVariables();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_RenameLocalVariable();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_SetCanEverTick();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_SetRunConstructionScriptOnDrag();
	ELGEDITORSCRIPTING_API UFunction* Z_Construct_UFunction_UElgEditorBP_UBlueprint_SetStartingWithTick();
...
static struct FScriptStruct_ElgEditorScripting_StaticRegisterNativesFS_ElgBlueprintsNodeStats
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("S_ElgBlueprintsNodeStats")),new UScriptStruct::TCppStructOps<FS_ElgBlueprintsNodeStats>);
	}
...
static struct FScriptStruct_ElgEditorScripting_StaticRegisterNativesFS_ElgBlueprintNodeStats
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("S_ElgBlueprintNodeStats")),new UScriptStruct::TCppStructOps<FS_ElgBlueprintNodeStats>);
	}
	...
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UElgEditorBP_UBlueprint_GetBlueprintsByPath_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ElgEditorBP_UBlueprint_eventGetBlueprintsByPath_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UElgEditorBP_UBlueprint_GetBlueprintsFromObjects_Statics::NewProp_Objects = { "Objects", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ElgEditorBP_UBlueprint_eventGetBlueprintsFromObjects_Parms, Objects), METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UElgEditorBP_UBlueprint_GetLocalVariableNames_Statics::NewProp_VariableNames = { "VariableNames", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ElgEditorBP_UBlueprint_eventGetLocalVariableNames_Parms, VariableNames), METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UElgEditorBP_UBlueprint_GetVariableNames_Statics::NewProp_VariableNames = { "VariableNames", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ElgEditorBP_UBlueprint_eventGetVariableNames_Parms, VariableNames), METADATA_PARAMS(nullptr, 0) };
